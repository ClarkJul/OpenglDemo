...
public class MyNativeRender {
    ...
    public static final int SAMPLE_TYPE_BEATING_HEART       = SAMPLE_TYPE + 19;
    public static final int SAMPLE_TYPE_CLOUD               = SAMPLE_TYPE + 20;
    public static final int SAMPLE_TYPE_TIME_TUNNEL         = SAMPLE_TYPE + 21;
    public static final int SAMPLE_TYPE_BEZIER_CURVE        = SAMPLE_TYPE + 22;
    public static final int SAMPLE_TYPE_BIG_EYES            = SAMPLE_TYPE + 23;
    public static final int SAMPLE_TYPE_FACE_SLENDER        = SAMPLE_TYPE + 24;
    public static final int SAMPLE_TYPE_BIG_HEAD            = SAMPLE_TYPE + 25;
    public static final int SAMPLE_TYPE_ROTARY_HEAD         = SAMPLE_TYPE + 26;
    public static final int SAMPLE_TYPE_VISUALIZE_AUDIO     = SAMPLE_TYPE + 27;
    public static final int SAMPLE_TYPE_SCRATCH_CARD        = SAMPLE_TYPE + 28;
    public static final int SAMPLE_TYPE_AVATAR              = SAMPLE_TYPE + 29;
    public static final int SAMPLE_TYPE_SHOCK_WAVE          = SAMPLE_TYPE + 30;
    public static final int SAMPLE_TYPE_MRT                 = SAMPLE_TYPE + 31;
    public static final int SAMPLE_TYPE_FBO_BLIT            = SAMPLE_TYPE + 32;
    public static final int SAMPLE_TYPE_TBO                 = SAMPLE_TYPE + 33;
    public static final int SAMPLE_TYPE_UBO                 = SAMPLE_TYPE + 34;
    public static final int SAMPLE_TYPE_RGB2YUYV            = SAMPLE_TYPE + 35;
    public static final int SAMPLE_TYPE_MULTI_THREAD_RENDER = SAMPLE_TYPE + 36;
    public static final int SAMPLE_TYPE_TEXT_RENDER         = SAMPLE_TYPE + 37;
    public static final int SAMPLE_TYPE_STAY_COLOR          = SAMPLE_TYPE + 38;
    public static final int SAMPLE_TYPE_TRANSITIONS_1       = SAMPLE_TYPE + 39;
    public static final int SAMPLE_TYPE_TRANSITIONS_2       = SAMPLE_TYPE + 40;
    public static final int SAMPLE_TYPE_TRANSITIONS_3       = SAMPLE_TYPE + 41;
    public static final int SAMPLE_TYPE_TRANSITIONS_4       = SAMPLE_TYPE + 42;
    public static final int SAMPLE_TYPE_RGB2NV21            = SAMPLE_TYPE + 43;
    public static final int SAMPLE_TYPE_RGB2I420            = SAMPLE_TYPE + 44;
    public static final int SAMPLE_TYPE_RGB2I444            = SAMPLE_TYPE + 45;
    public static final int SAMPLE_TYPE_HWBuffer            = SAMPLE_TYPE + 46;
