 ...
 * 2022/1/9 20:59
 */
class MultiRender implements GLSurfaceView.Renderer {
    private float rot = 0.0f;

    //顶点数组
    private FloatBuffer vertices = createBuffer(new float[]{
            // FRONT
            0.5f, -0.5f, 0.5f,
            0.5f, 0.5f, 0.5f,
            -0.5f, -0.5f, 0.5f,
    ...
    //纹理坐标数组
    private FloatBuffer texCoords = createBuffer(new float[]{
            // FRONT
            0.0f, 1.0f,
            0.0f, 0.0f,
            1.0f, 1.0f,
